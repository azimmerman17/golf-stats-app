...
def upgrade():
    ...
    sa.Column('USER_GENDER', sa.Enum('M', 'F', 'N', 'P', name='USER_GENDER'), server_default='P', nullable=False),
    ...
    sa.Column('ACTIVE', sa.String(length=1), nullable=False, server_default='A'),
    sa.Column('GUID_TOKEN', sa.String(length=150), nullable=False),
